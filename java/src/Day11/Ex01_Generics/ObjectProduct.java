...
import Day07.Ex03_ClassCating.Studnet;
...
public class ObjectProduct {
	...
	public static void main(String[] args) {
		...
		person1.setObject( new Studnet() ); // 업 케스팅
		// 단점 : 다시 Student 타입으로 변환해서 사용해야한다. (다운 케스팅)
		Studnet studnet = (Studnet) person1.getObject();
